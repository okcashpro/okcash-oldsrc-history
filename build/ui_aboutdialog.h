...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About PimpCash", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>PimpCash</b> version", 0));
...
"Copyright \302\251 2014 The PimpCash developers", 0));
