...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 PIMP"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 PIMP"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 PIMP"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 PIMP"));
